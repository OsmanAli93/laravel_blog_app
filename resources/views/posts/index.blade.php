                    ...
                    <div class="post-wrapper bg-white rounded p-5">
                        ...
                        <form action="{{ route('posts') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" name="description" id="desc" class="form-control @error('description') border-danger @enderror">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea name="message" id="message" cols="30" rows="5" class="form-control" value="{{ old('message') }}"></textarea>
